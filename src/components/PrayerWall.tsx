/*
 * Prayer Wall Component (Simple Email Form)
 * Design: "Sacred Warmth" — Liturgical Modernism
 * Allows visitors to submit prayer requests via simple email form
 */
...
export default function PrayerWall() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const mailtoLink = `mailto:christiansglobalcommunity@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
    
    // Open email client
    window.location.href = mailtoLink;
    
    toast.success("Your email client is opening. Please send the email to submit your prayer request.");
      ...
      <div ref={ref} className="container relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            . We believe in the power of collective prayer and intercession.
          </p>
        </div>
          ...
          >
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full px-8 py-3.5 bg-gold text-charcoal font-semibold text-sm tracking-wide uppercase rounded-sm hover:bg-gold-light transition-all duration-300 shadow-lg shadow-gold/20 flex items-center justify-center gap-2"
                  style={{ fontFamily: "var(--font-body)" }}
                >
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
                  >
                    Enter your name, email (optional), and your prayer request.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
                  >
                    Your prayer request is sent directly to our community leaders.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p
                    ...
                    style={{ fontFamily: "var(--font-body)", fontWeight: 300 }}
                  >
                    We intercede on your behalf and trust in God's faithfulness.
                  </p>
                </div>
              </div>
            </div>
